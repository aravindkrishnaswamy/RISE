...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ${OPTIONS}
        # RISE overlay customization: build x265 for 10-bit (Main10) so that
        # FFmpeg's libx265 encoder can produce HEVC HDR10 (yuv420p10le).  The
        # stock vcpkg x265 port builds 8-bit only (HIGH_BIT_DEPTH=0,
        # X265_DEPTH=8), which makes avcodec_open2 reject the 10-bit pixel
        # format ("Could not open codec").  HIGH_BIT_DEPTH=ON => X265_DEPTH=10.
        -DHIGH_BIT_DEPTH=ON
