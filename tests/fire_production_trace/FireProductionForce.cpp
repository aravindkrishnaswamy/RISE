			...
			for(std::uint32_t iteration=0u;iteration<request_.maximumPicardIterations;
				...
				if(!frozenActiveCycle&&!classStable){
					...
					if(repeated!=activeHistory.end()){
						...
						FireProductionRoundoffTrace::TraceFloat selectedDiscrepancy=0.0f;bool haveSelected=false;
			...
			for(std::uint32_t iteration=0u;iteration<request_.maximumPicardIterations;
				...
				if(!frozenCycle){
					...
					if(repeated!=activeHistory.end()){
						...
						std::size_t selected=first;FireProductionRoundoffTrace::TraceFloat selectedDiscrepancy=0.0f;
