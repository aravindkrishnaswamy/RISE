...
namespace RISEFireProductionTrace
{
	...
	struct FireProductionFrozenForceResult
	{
		...
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> gravityMomentumRateKGPerM2S2;
	...
	struct FireProductionNonpressureMomentumRHSRequest
	{
		...
		std::vector<FireProductionRoundoffTrace::TraceFloat> cellGasPhaseSourceRateKGPerM3S;
	};
	...
	struct FireProductionNonpressureMomentumRHSResult
	{
		...
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> combinedMomentumRateKGPerM2S2;
	};
	...
	struct FireProductionProjectedHeunMetalOwnerResult
	{
		...
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> heunAdvectionMomentumRateKGPerM2S2;
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> heunBuoyancyMomentumRateKGPerM2S2;
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> heunStressMomentumRateKGPerM2S2;
		std::array<std::vector<FireProductionRoundoffTrace::TraceFloat>,3> heunPhaseSourceMomentumRateKGPerM2S2;
		std::vector<FireProductionRoundoffTrace::TraceFloat> acceptedFaceAlpha;
		std::vector<FireProductionRoundoffTrace::TraceFloat> heunEddyKinematicViscosityM2PerS;
		FireProductionProjectionResult projection;
		...
		FireProductionRoundoffTrace::TraceFloat commutingIdentityBoundKGPerM3;
	...
	struct FireProductionSingleStageFCTDiagnosticResult
	{
		...
		FireProductionRoundoffTrace::TraceFloat maximumCommutingResidual;
		FireProductionRoundoffTrace::TraceFloat scalarStageGamma128;
		FireProductionRoundoffTrace::TraceFloat maximumScalarStageAbsoluteDifference;
		FireProductionRoundoffTrace::TraceFloat maximumScalarStageNormalizedDifference;
		FireProductionRoundoffTrace::TraceFloat maximumCompatibleRateAbsoluteDifference;
		FireProductionRoundoffTrace::TraceFloat maximumCompatibleRateNormalizedDifference;
