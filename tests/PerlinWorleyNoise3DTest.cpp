...
bool TestBlendZeroMatchesPerlin()
{
	...
	RealLinearInterpolator* interp = new RealLinearInterpolator();
	PerlinWorleyNoise3D* hybrid = new PerlinWorleyNoise3D( *interp, 0.65, 4, 1.0, 0.0 ); // blend=0 = pure Perlin
...
bool TestBlendOneMatchesWorley()
{
	...
	RealLinearInterpolator* interp = new RealLinearInterpolator();
	PerlinWorleyNoise3D* hybrid = new PerlinWorleyNoise3D( *interp, 0.65, 4, 1.0, 1.0 ); // blend=1 = pure Worley
