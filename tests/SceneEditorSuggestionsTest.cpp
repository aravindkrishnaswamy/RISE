...
void TestGrammarCoverage()
{
	...
	// 136 chunk types in the parser registry as of camera Phase 1.2.
	// This includes the legacy alias `mis_pathtracing_shaderop` (shares a
	// class with `pathtracing_shaderop`), the Phase 2 + Phase 3 glTF chunks
	// (channel_painter, pbr_metallic_roughness_material, gltf_import,
	// gltfmesh_geometry, normal_map_modifier, alpha_test_shaderop), and the
	// camera Phase 1.1/1.2 chunks (camera_defaults, scene_options).  Bump
