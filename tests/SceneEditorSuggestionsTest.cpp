...
// all 159 chunk keywords are enumerable, context resolution picks the
...
void TestGrammarCoverage()
{
	...
	// 158 unique descriptors -- 159 keyword entries, but the mis_pathtracing_shaderop alias shares a
