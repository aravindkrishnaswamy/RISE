...
// all 163 chunk keywords are enumerable, context resolution picks the
...
void TestGrammarCoverage()
{
	...
	// The parser registry holds 175 chunk types; the EXPECT below carries the
	...
	EXPECT( kws.size() == 175 );	// 2026-05 Camera/Film/Output split: + `film`; 2026-05 painters: + composite_function2d_painter + polynomial_function2d_painter; 2026-05 IScalarPainter refactor: + scalar_painter; Phase 6.2 round-trip save: + override_object; 2026-06 auto-rasterizer dispatcher: + auto_rasterizer (Phase 1); 2026-06 auto-rasterizer Phase 1b: + auto_spectral_rasterizer; 2026-06 SDF geometry: + sdf_geometry; 2026-06 procedural general sweeps: + sweep_geometry + path_instances_geometry; 2026-06 temper-comparison: + function2d_painter; 2026-06 general patterning: + expression_function2d + cartesian_disk_geometry (retired guilloche_disk_geometry AND guilloche_oxide_painter: dials are an expression_function2d displaced onto cartesian_disk_geometry, and the oxide heat-tint is in-scene expression_function2d math); 2026-06 named animation paths: + animation (the named-animation grouping chunk); 2026-06 CST v6->v7 migrator: + global_medium (the v7 form of `> set global_medium`); 2026-06 scene variants: + scene_variant + active_scene_variant; 2026-06 CST v6->v7 cutover: + light_rr_threshold; 2026-07 discrete-facet glints: + glint_modifier; 2026-08 arc-83 slice 3 one-chunk area light: + rect_light; 2026-08 arc-83 slice 4 solid area light: + shape_light; 2026-08-14 arc-85 C1 joint-graph creature flesh: + skeleton_geometry; 2026-08-18 arc-85 C3 surface of revolution: + lathe_geometry; 2026-08-19 doc-88 P1 S2 texture-expression VM colour pipe: + expression_painter (scalar_painter's `expression` form is a new FIELD on an existing chunk, not a new keyword); 2026-08-19 doc-88 S3 P2.2 universal scalar->colour remap: + ramp_painter (P2.1's scalar_painter{painter} bridge is a new FIELD on an existing chunk, not a new keyword); 2026-08-20 doc-88 S7 P2.3 domain mapping wrapper: + mapping_painter (P2.4 blend_painter `mode` and P2.5 voronoi3d_painter `space` are new FIELDs on existing chunks, not new keywords); 2026-08-20 doc-88 P3 S8 stochastic richness: + stochastic_tile_painter + scatter_painter; 2026-08-22 doc-89 slice B ruled/billowed membrane between two rails: + skin_geometry; 2026-08-25 hair arc slices B and D: + hair_material + hair_geometry (BOTH landed WITHOUT bumping this count, so it sat two short from ce22a7a2/bddb2307 until this line was written -- the suite was red on exactly these two EXPECTs before the guides work began); 2026-08-27 hair Phase 2 slice P2-A authored guide strands: + hair_guides; 2026-08-31 WETNESS_COAT_DESIGN.md Phase 2 (`coated_material` triad): + coated_material; 2026-09-02 CLOTH_FABRIC_DESIGN.md Phase 1 (`fabric_material` triad): + fabric_material; 2026-09-03 CLOTH_FABRIC_DESIGN.md Phase 2 slice P2-A (`weave_material` triad): + weave_material; 2026-09-05 RELIEF_MODIFIER_DESIGN.md Phase 1 (painter-driven micro-relief): + relief_modifier; 2026-09-06 RELIEF_MODIFIER_DESIGN.md Phase 2 (modifier composition): + modifier_stack; 2026-09-06 RELIEF_MODIFIER_DESIGN.md Phase B (bumpmap_modifier REMOVED, its chunk parser and registry entry deleted; a scene still carrying one is refused by Cst.cpp's kRetiredChunks table, which names relief_modifier and tools/migrate_scenes_relief.py): - bumpmap_modifier
	...
	// 159 unique descriptors -- 160 keyword entries, but the mis_pathtracing_shaderop alias shares a
...
void TestSuggestChunkKeywordsAtRoot()
{
	...
	EXPECT( sugs.size() == 175 );	// kept in lockstep with TestGrammarCoverage's kws.size() count above; see its per-addition history, + 2026-08-19 doc-88 S3: + ramp_painter; 2026-08-20 doc-88 S7: + mapping_painter; 2026-08-20 doc-88 P3 S8: + stochastic_tile_painter + scatter_painter; 2026-08-22 doc-89 slice B: + skin_geometry; 2026-08-25 hair slices B/D (retroactively counted): + hair_material + hair_geometry; 2026-08-27 hair P2-A: + hair_guides; 2026-08-31 WETNESS_COAT_DESIGN.md Phase 2: + coated_material; 2026-09-02 CLOTH_FABRIC_DESIGN.md Phase 1: + fabric_material; 2026-09-03 CLOTH_FABRIC_DESIGN.md Phase 2 slice P2-A: + weave_material; 2026-09-05 RELIEF_MODIFIER_DESIGN.md Phase 1: + relief_modifier; 2026-09-06 RELIEF_MODIFIER_DESIGN.md Phase 2: + modifier_stack; 2026-09-06 RELIEF_MODIFIER_DESIGN.md Phase B: - bumpmap_modifier (removed)
