...
void TestGrammarCoverage()
{
	...
	// The parser registry holds 165 chunk types; the EXPECT below carries the
...
void TestSuggestChunkKeywordsAtRoot()
{
	...
	EXPECT( sugs.size() == 165 );	// kept in lockstep with TestGrammarCoverage's kws.size() count above; see its per-addition history, + 2026-08-19 doc-88 S3: + ramp_painter; 2026-08-20 doc-88 S7: + mapping_painter
