...
void TestGrammarCoverage()
{
	...
	EXPECT( kws.size() == 150 );	// 2026-05 Camera/Film/Output split: + `film`; 2026-05 painters: + composite_function2d_painter + polynomial_function2d_painter; 2026-05 IScalarPainter refactor: + scalar_painter; Phase 6.2 round-trip save: + override_object; 2026-06 auto-rasterizer dispatcher: + auto_rasterizer (Phase 1); 2026-06 auto-rasterizer Phase 1b: + auto_spectral_rasterizer; 2026-06 SDF geometry: + sdf_geometry; 2026-06 procedural guilloché: + guilloche_dial_geometry + guilloche_oxide_painter + swept_band_geometry
...
void TestSuggestChunkKeywordsAtRoot()
{
	...
	EXPECT( sugs.size() == 150 );	// 2026-05 Camera/Film/Output split: + `film`; 2026-05 painters: + composite_function2d_painter + polynomial_function2d_painter; 2026-05 IScalarPainter refactor: + scalar_painter; Phase 6.2 round-trip save: + override_object; 2026-06 auto-rasterizer dispatcher: + auto_rasterizer (Phase 1); 2026-06 auto-rasterizer Phase 1b: + auto_spectral_rasterizer; 2026-06 SDF geometry: + sdf_geometry; 2026-06 procedural guilloché: + guilloche_dial_geometry + guilloche_oxide_painter + swept_band_geometry
