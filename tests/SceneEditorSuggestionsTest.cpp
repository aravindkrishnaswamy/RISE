...
void TestGrammarCoverage()
{
	...
	// The parser registry holds 164 chunk types; the EXPECT below carries the
...
void TestSuggestChunkKeywordsAtRoot()
{
	...
	EXPECT( sugs.size() == 164 );	// kept in lockstep with TestGrammarCoverage's kws.size() count above; see its per-addition history, + 2026-08-19 doc-88 S3: + ramp_painter
