...
void TestGrammarCoverage()
{
	...
	// The parser registry holds 173 chunk types; the EXPECT below carries the
...
void TestSuggestChunkKeywordsAtRoot()
{
	...
	EXPECT( sugs.size() == 173 );	// kept in lockstep with TestGrammarCoverage's kws.size() count above; see its per-addition history, + 2026-08-19 doc-88 S3: + ramp_painter; 2026-08-20 doc-88 S7: + mapping_painter; 2026-08-20 doc-88 P3 S8: + stochastic_tile_painter + scatter_painter; 2026-08-22 doc-89 slice B: + skin_geometry; 2026-08-25 hair slices B/D (retroactively counted): + hair_material + hair_geometry; 2026-08-27 hair P2-A: + hair_guides; 2026-08-31 WETNESS_COAT_DESIGN.md Phase 2: + coated_material; 2026-09-02 CLOTH_FABRIC_DESIGN.md Phase 1: + fabric_material
