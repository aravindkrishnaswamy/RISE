...
> **Updated per [`01-DECISIONS.md`](01-DECISIONS.md) (rounds 1–5).** Where this
> doc previously hedged behind open decisions (O1/O2/O3) or offered forks, it now
> conforms to the ratified decisions **D1–D44** (round 2's D11–D20, round 3's
> D21–D28, round 4's **D29–D37**, and round 5's **D38–D44** *amend* several earlier
> decisions and win where they conflict). The
...
> normalized **`ResolveEffectiveRenderConfig(CST,request)`** (scene-authored ← request ←
...
`ResolveEffectiveRenderConfig(CST,request)` = scene-authored←request←defaults←auto-resolution,
