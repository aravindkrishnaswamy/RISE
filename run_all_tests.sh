...
# The r133 derivation refusal is a capability-isolated evidence gate, not a test
# source with its own executable name. Run the capability-isolated binary
# explicitly and accept only the exact fail-closed projection-amplification result.
roundoff_name="FireProductionCalibrationOracle.r133"
