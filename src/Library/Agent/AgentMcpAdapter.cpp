			...
			JsonValue BuildToolsList( AgentAutonomy autonomy )
			{
				...
				// drift-class reason recorded on file_build_plan above.
				{
					...
					const std::string desc =
						...
						"size, facing, color and exitance; the parser expands it into the general "
						"form, which is what any other shape of emitter needs -- an "
						...
						"for special cases. ambient_light is NOT offered and is REFUSED on every "
