...
namespace
{
	...
	bool IsMutatingMcpToolCall( const std::string& body, std::string& outToolName )
	{
		...
		if( name == "propose_patch" || name == "insert_chunk"   ||
		    ...
		    // Arc-75 slice S2.1: insert_material_scaffold expands into
		    // MULTIPLE chunks per call via the SAME InsertChunks path
		    ...
		    name == "add_wetness" ||
		    // CLOTH_FABRIC_DESIGN 9.7 (2026-09-02): make_fabric rewrites
