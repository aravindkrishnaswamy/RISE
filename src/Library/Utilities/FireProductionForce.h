...
namespace RISE
{
	...
	struct FireProductionProjectedHeunIterationTrace
	{
		...
		std::vector<float> acceptedConservativeValues;
	...
	struct FireProductionProjectedHeunMetalOwnerRequest
	{
		...
		FireProductionProjectedHeunMetalOwnerRequest() : ambientDensityKGPerM3(1.0f),
			...
			endpointVelocityToleranceMPerS(0.0f),maximumPicardIterations(64u),
	...
	struct FireProductionProjectedHeunMetalOwnerResult
	{
		...
		std::array<std::vector<float>,3> velocityMPerS;
		std::array<std::vector<float>,3> provisionalMomentumKGPerM2S;
		std::array<std::vector<float>,3> heunAdvectionMomentumRateKGPerM2S2;
		std::array<std::vector<float>,3> heunBuoyancyMomentumRateKGPerM2S2;
		std::array<std::vector<float>,3> heunStressMomentumRateKGPerM2S2;
		std::array<std::vector<float>,3> heunPhaseSourceMomentumRateKGPerM2S2;
		std::vector<float> acceptedFaceAlpha;
		std::vector<float> heunEddyKinematicViscosityM2PerS;
		FireProductionProjectionResult projection;
		...
		float commutingIdentityBoundKGPerM3;
		...
		FireProductionProjectedHeunMetalOwnerResult() : ownerPublicationIdentity(0u),
			...
			commutingIdentityScaleKGPerM3(0.0f),commutingIdentityBoundKGPerM3(0.0f),
