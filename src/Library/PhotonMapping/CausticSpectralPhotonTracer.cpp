...
CausticSpectralPhotonTracer::CausticSpectralPhotonTracer( 
  ...
  SpectralPhotonTracer<CausticSpectralPhotonMap>( nm_begin_, nm_end_, num_wavelengths_, powerscale, temporal_samples, regenerate ),
  nMaxRecursions( maxR ),
  dExtinction( ext ),
  bBranch( branch ),
	...
	) const
{
	...
	if( ri.geometric.bHit )
	{
		...
		// GGX conductor Fresnel evaluated in SPF::ScatterNM sees the surrounding
