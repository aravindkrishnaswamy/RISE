//////////////////////////////////////////////////////////////////////
//
//  CausticSpectralPhotonMapShaderOp.h - The caustic spectral pmap shader op 
//    evaluates the results of a caustic spectral photon map if one
//    exists in the scene
//
...
#ifndef CAUSTICSPECTRALPHOTONMAP_SHADER_OP_
#define CAUSTICSPECTRALPHOTONMAP_SHADER_OP_
...
namespace RISE
{
	...
	{
		class CausticSpectralPhotonMapShaderOp : 
			public virtual IShaderOp, 
			public virtual Reference
		{
		protected:
			virtual ~CausticSpectralPhotonMapShaderOp();

		public:
			CausticSpectralPhotonMapShaderOp( 
				);
