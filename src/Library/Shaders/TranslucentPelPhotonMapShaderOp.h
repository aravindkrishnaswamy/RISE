//////////////////////////////////////////////////////////////////////
//
//  TranslucentPelPhotonMapShaderOp.h - The translucent pel pmap shader op
//    evaluates the results of a translucent pel photon map if one
//    exists in the scene
//
...
#ifndef TRANSCLUENTPELPHOTONMAP_SHADER_OP_
#define TRANSCLUENTPELPHOTONMAP_SHADER_OP_
...
namespace RISE
{
	...
	{
		class TranslucentPelPhotonMapShaderOp :
			public virtual IShaderOp,
			public virtual Reference
		{
		protected:
			virtual ~TranslucentPelPhotonMapShaderOp();

		public:
			TranslucentPelPhotonMapShaderOp(
				);
