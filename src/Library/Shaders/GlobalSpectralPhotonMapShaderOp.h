//////////////////////////////////////////////////////////////////////
//
//  GlobalSpectralPhotonMapShaderOp.h - The global spectral pmap shader op 
//    evaluates the results of a global spectral photon map if one
//    exists in the scene
//
...
#ifndef GLOBALSPECTRALPHOTONMAP_SHADER_OP_
#define GLOBALSPECTRALPHOTONMAP_SHADER_OP_
...
namespace RISE
{
	...
	{
		class GlobalSpectralPhotonMapShaderOp : 
			public virtual IShaderOp, 
			public virtual Reference
		{
		protected:
			virtual ~GlobalSpectralPhotonMapShaderOp();

		public:
			GlobalSpectralPhotonMapShaderOp( 
				);
