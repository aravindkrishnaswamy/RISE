//////////////////////////////////////////////////////////////////////
//
//  CausticPelPhotonMapShaderOp.h - The caustic pel pmap shader op 
//    evaluates the results of a caustic pel photon map if one
//    exists in the scene
//
...
#ifndef CAUSTICPELPHOTONMAP_SHADER_OP_
#define CAUSTICPELPHOTONMAP_SHADER_OP_
...
namespace RISE
{
	...
	{
		class CausticPelPhotonMapShaderOp : 
			public virtual IShaderOp, 
			public virtual Reference
		{
		protected:
			virtual ~CausticPelPhotonMapShaderOp();

		public:
			CausticPelPhotonMapShaderOp( 
				);
