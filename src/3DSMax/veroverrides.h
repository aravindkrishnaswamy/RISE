...
#define MAXVER_INTERNALNAME "rise3dsmax\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "rise3dsmax.dlr\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "RISE renderer (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "Aravind Krishnaswamy\0"//should  be overidden on a per-dll level
